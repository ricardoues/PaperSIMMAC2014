...
%The physical properties of slope-forming materials, such as strength and permeability, are related to the lithology factor, which therefore should affect the likelihood of slope failure (\cite{dai2002}). 
...
\item {\bf Road distance:} Distance in kilometers to the nearest road. Road map was obtained from digitalized national cartography from Centro Nacional de Registros de la Rep\'{u}blica de El Salvador (CNR).
