...
\pagestyle{fancy}
\fancyhead{}
\fancyhead[RE]{\thepage \hfill {\sc r. ríos -- c.gámez }}
\fancyhead[LO]{{\sc combining neural networks and geostatistics for landslide hazard assessment of san salvador department, el salvador } \hfill \thepage}
\fancyfoot{}
...
\paginas{1}{10} % Numeros de página, la versión final la pone el editor; Page numbers, the Editor puts the final numbers
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{graphics}
...
\title{Combining neural networks and geostatistics for landslide hazard assessment of San Salvador Department, El Salvador 
\newline
\newline
Combinando redes neuronales y geoestadística para evaluación de deslizamientos de tierra en San Salvador,Departamento de El Salvador}

\author[1]{Ricardo Ríos \thanks{ricardo.rios.sv@gmail.com}}
\author[2]{Carlos Gámez \thanks{gamez9e@yahoo.com}}
\affil[1]{Department of Mathematics, Science and Mathematics Faculty, University of El Salvador, El Salvador.}
\affil[2]{Department of Mathematics, Science and Mathematics Faculty, University of El Salvador, El Salvador.}
...
\KW landslide, hazard assessment, San Salvador, El Salvador, ANN, geostatistics.
...
%, fuzzy set theory (\citet{Kanungo2006347} and \citet{Guettouche20133163}) 
and neural networks (\cite{Melchiorre2011410},\cite{Zeng2001374} and \cite{Ermini2005327}).
...
aerial photo from SNET-MARN which is presented in the Figure \ref{fig:img01}, where white areas represent regions of landslide occurrence which were processed using the software ILWIS. 
...
Once that the white areas were georeferenced, a percentage of 0.5\% of the total points georeferenced shows landslide ocurrence. In addition to the landslide information the following data sources of input variables was given by SNET-MARN: 
\begin{enumerate}
\item {\bf Geomorphology:} refers to landforms that result from lithospheric dynamics of geographic area.

\item {\bf Slope:} derived from digital elevation model MARN-SNET
...
The method used for estimating the parameters of the model was an Hybrid Method: First of all Genetic Algorithms were used to avoid getting stuck in a local rather than a global minimum of error function, after that a local search was applied again to obtain a new local minimun.  
...
The authors are indebted to M.SC. Giovanni Molina from SNET who provided the data and useful information about landslide modelling techniques.
